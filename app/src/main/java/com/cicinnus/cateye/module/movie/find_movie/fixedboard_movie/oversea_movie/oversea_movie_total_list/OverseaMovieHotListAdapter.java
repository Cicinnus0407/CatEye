...
public class OverseaMovieHotListAdapter extends BaseMultiItemQuickAdapter<OverseaHotMovieBean.DataBean.HotBean, BaseViewHolder> {

    public OverseaMovieHotListAdapter() {
        super(null);
