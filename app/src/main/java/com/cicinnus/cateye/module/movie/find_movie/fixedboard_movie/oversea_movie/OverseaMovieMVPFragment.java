...
public class OverseaMovieMVPFragment extends BaseMVPFragment<OverseaMovieMVPPresenter> implements OverseaMovieContract.IOverseaMovieView {
    ...
    public static OverseaMovieMVPFragment newInstance(String area) {

        Bundle args = new Bundle();
        args.putString(AREA, area);
        OverseaMovieMVPFragment fragment = new OverseaMovieMVPFragment();
    ...
    @Override
    protected OverseaMovieMVPPresenter getPresenter() {
        return new OverseaMovieMVPPresenter(mContext, this);
    }
    ...
    public void addOverseaComingMovie(final List<OverseaComingMovieBean.DataBean.ComingBean> coming) {
        Observable.fromIterable(coming)
                ...
                .compose(SchedulersCompat.<OverseaHotMovieBean.DataBean.HotBean>applyIoSchedulers())
                .toList()
