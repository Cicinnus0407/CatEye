...
public class FloatingHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public FloatingHeaderDecoration(Context context) {
     ...
     */
    public FloatingHeaderDecoration(Context context, @DrawableRes int drawableId) {
     ...
     */
    public FloatingHeaderDecoration(Context context, @ColorInt int color, @Dimension float dividerWidth, @Dimension float dividerHeight) {
