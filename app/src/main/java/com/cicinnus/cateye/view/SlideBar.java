...
public class SlideBar extends View {
    ...
    public interface OnTouchingLetterChangedListener {
        void onTouchingLetterChanged(String s,int offset);
    }
    ...
    public SlideBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int mResArrayId = R.array.letter_list;
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (mChoose != characterIndex) {
                        ...
                        mOnTouchingLetterChangedListener.onTouchingLetterChanged(mLetters[mChoose],(int)moveY);
                    }
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mOnTouchingLetterChangedListener != null) {
                    if (mIsBeingDragged) {
                        mOnTouchingLetterChangedListener.onTouchingLetterChanged(mLetters[mChoose],0);
                    } else {
                        float downY = ev.getY() - getPaddingTop();
                        final int characterIndex = (int) (downY / mHalfHeight * mLetters.length);
                        if (characterIndex >= 0 && characterIndex < mLetters.length) {
                            mOnTouchingLetterChangedListener.onTouchingLetterChanged(mLetters[characterIndex],0);
                        }
                    }
                }
